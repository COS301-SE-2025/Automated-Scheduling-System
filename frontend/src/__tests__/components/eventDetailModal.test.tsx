...
} from "../../components/ui/EventDetailModal";
...
describe("EventDetailModal", () => {
  ...
  const createMockEvent = (
    overrides: Partial<EventClickArg["event"]> & { extendedProps?: any }
  ): EventClickArg["event"] => {
    const baseEvent = {
      id: "test-event-1",
    ...
    const finalExtendedProps =
      "extendedProps" in overrides
  ...
  it("should render all event details correctly", () => {
    ...
    checkDetailItem(
      "Created On",
      formatDisplayDateTime(new Date("2024-07-01T10:00:00Z"))
    );
  });
